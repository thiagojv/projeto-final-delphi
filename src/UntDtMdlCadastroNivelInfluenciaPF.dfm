inherited DtMdlCadastroNivelInfluenciaPF: TDtMdlCadastroNivelInfluenciaPF
  inherited sqldtstCadastro: TSQLDataSet
    CommandText = 
      'SELECT'#13#10#9'Codigo,'#13#10#9'Nota,'#13#10#9'Descricao'#13#10'FROM PF_Nivel_Influencia'#13#10 +
      'ORDER BY'#13#10#9'Descricao'
    MaxBlobSize = -1
  ...
  inherited clntdtstCadastro: TClientDataSet
    ...
    object clntdtstCadastroNota: TIntegerField
      FieldName = 'Nota'
      Required = True
    end
