inherited DtMdlCadastroCaracteristicasPF: TDtMdlCadastroCaracteristicasPF
  inherited sqldtstCadastro: TSQLDataSet
    CommandText = 
      'SELECT'#13#10#9'Codigo,'#13#10#9'Descricao'#13#10'FROM PF_Caracteristicas'#13#10'ORDER BY'#13 +
      #10#9'Descricao'
    MaxBlobSize = -1
